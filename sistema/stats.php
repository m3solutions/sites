...
<div class="outer">
  <div class="statistics">
    <h3 class="modalH">Estatisticas do Sistema </h3>
    <!-- Sources -->
    <div class="statsSec">
      <h2 class="left">Origens dos Leads </h2>

      <div id="leadSourceChart"></div>

      <div class="leadList">
        <table class="leadTable">
          <tr><th>Origem </th><th>Contagem</th></tr>
    <?php
    ...
    <!-- End Sources -->
        ...
        <!-- Types -->
    <div class="statsSec">
      <h2 class="left">Tipos de Leads </h2>
      <div id="leadTypeChart"></div>
    
      <div class="leadList">
        <table class="leadTable">
          <tr><th>Tipo</th><th>Contador</th></tr>
    <?php
    ...
    <!-- Status -->
    <div class="statsSec">
      <h2 class="left">Leads por Status</h2>
    ...
    <!-- New Leads Per Month -->
    <div class="statsSec">
      <h2 class="left">Novos Leads nos últimos 12 meses </h2>

      <div id="newLeadsMonth"></div>

      <div class="leadList">
        <table class="leadTable">
          <tr><th>Mês</th><th>Contador</th></tr>
    <?php
